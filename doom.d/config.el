...
(setq user-full-name "Anon Ray"
      user-mail-address "rayanon004@gmail.com")
...
(setq doom-theme 'doom-city-lights) ; 'doom-material ;'doom-one ;'doom-monokai-pro)
...
;; (map! :leader
;;       :desc "Jump to definition (new window)"
